...
[![Deploy](https://github.com/EvanilsonFreitas/oneb-website/actions/workflows/deploy.yml/badge.svg)](https://github.com/EvanilsonFreitas/oneb-website/actions/workflows/deploy.yml)
...
[Demo ao vivo](https://evanilsonfreitas.github.io/oneb-website/) · [Documentação](./docs) · [Reportar um problema](https://github.com/EvanilsonFreitas/oneb-website/issues)
...
```bash
git clone https://github.com/EvanilsonFreitas/oneb-website.git
cd oneb-website
npm install
npm run dev
```
